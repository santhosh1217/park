...
############################################################################## department #################################
    ...
    path("<str:user>/<str:department>/<str:year>/",views.department),

############################################################################## edit #######################################

    path("<str:user>/<str:department>/<str:year>/admin/",views.admin),
...
#############################################################################  attendance #################################
    path("<str:user>/<str:department>/<str:year>/submit/",views.submit),
